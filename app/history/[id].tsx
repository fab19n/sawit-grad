    ...
    <View style={r.screen}>
      ...
      <ScrollView style={r.scroll} contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={r.card}>
          ...
          <View style={r.gHead}>
            <Text style={[r.gHCol, { flex: 2 }]}>Penggredan</Text>
...
const r = StyleSheet.create({
  ...
  headerSno:  { color: COLORS.gold, fontSize: 18, fontWeight: '700', letterSpacing: 2, fontVariant: ['tabular-nums'] },
  scroll:     { flex: 1 },
  ...
  snoBadge:   { backgroundColor: COLORS.accent, alignSelf: 'flex-start', paddingHorizontal: 18, paddingVertical: 6, borderRadius: 6 },
